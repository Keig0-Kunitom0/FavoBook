...
## アプリ概要
#### コンセプト
- お気に入り(Favo）本を通じて人と人とがつながる

ただ単に本を検索できるだけでなく

- 本のレビューやお気に入り登録
- 他人のレビュー一覧やお気に入り一覧もユーザーページから見れる
- フォロー/フォロワー機能

などといった機能があり本のSNSといった感じのアプリです。

## 開発した背景
- 私自身本が好きで、本を瞬時に検索、お気に入り登録ができ、気に入った意見(レビュー)をする人をフォローできるようなアプリがあればいいな、といった好奇心から作り始めました。

## 今後の展望
- UI/UXの部分に関してはもう少し改良を重ねていきたいです。
- フォローユーザーのレビューをTwitterのタイムラインのような形で見れるようにしていこうと思っています。
- 書籍検索画面からでもその本の星（評価）が見れるようにしたいです。
